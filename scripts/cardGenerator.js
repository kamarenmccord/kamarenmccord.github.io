...
const newData = [
    ...
    },
    {
        ...
        'lesson':"a walkthough by cleverprogrammer this was a bit painful to set up as they were using chrome but I wanted to use firefox. after a bit of debugging i was finally able to get my feet of the ground",
        "blog": "Learning how to get this started was a bit of a pain but the app is actually a pretty handy concept. I should probably set back and finish this as it would definatly help me oragnize my thoughts and get mind focused on the task at hand. The hardest thing to figure out was getting the broswer history to work. wait is it cache localhistory or system memory?"
    },
    {
    ...
    },
    {
        ...
        'lesson': 'My first up close expeirence in the workplace. This was so confusing for me at first. Communication is vital when you work with many people.',
    ...
    },
    {
        ...
        'lesson': 'First large project that allowed me to quickly generate my weekly gocerylist and turning my code into something more tangable!',
        'blog':"This was my very first project that I built on my own after learning python. This task was very large and I had to collaborate to find out what all went into each meal. After sitting down and setting this up it no longer took my family half hour to an hour of picky descisions. A quick 2 minutes in the command line and I could print out a oragnized grocery list! If only this came with graphics... "
    }
]
